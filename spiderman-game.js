(function(window, document) {
	...
	document.addEventListener("DOMContentLoaded", () => {
		...
		startButton.addEventListener("click", () => {
			...
			game = new SpidermanGame({ canvas: "#game-canvas" });
			game.startGame(); // Explicitly start the game
		});
	});
	...
	SpidermanGame.prototype.startGame = function() {
		this.started = true; // Signal that the game has started
		this.update();       // Begin the game loop
	};	
	...
	SpidermanGame.prototype.update = function() {
		if (!this.started) return; // Prevent updates before the game starts
